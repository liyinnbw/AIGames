...
const QMetaObjectExtraData Wuziqi::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Wuziqi::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Wuziqi,
      qt_meta_data_Wuziqi, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Wuziqi::getStaticMetaObject() { return staticMetaObject; }
