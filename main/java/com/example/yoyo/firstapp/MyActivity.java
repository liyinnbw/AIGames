...
public class MyActivity extends ActionBarActivity {
    ...
    public void newGame() {
        ...
        RelativeLayout.LayoutParams params1 = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, getWindowManager().getDefaultDisplay().getWidth());
